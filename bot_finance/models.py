...
class ConfirmPaymentQueue(models.Model):
    ...
    status = models.PositiveIntegerField(default=0,
                                         choices=[(0, "waiting for upload picture"), (1, "waiting for confirmation"),
                                                  (2, "first confirme"), (3, "second confirm"), (10, "denied")])
    ...
    def __str__(self):
        return str(self.custumer.chat_id)
...
class OffCodes(models.Model):
    ...
    type_off = models.IntegerField(choices=[(0, "amount"), (1, "percent")])
...
class CreateConfigQueue(models.Model):
    ...
    sent_to_user = models.IntegerField(default=0, choices=[(0, "Created"), (1, "pending"), (2, "sent"), (5, "Faild")])
    pay_status = models.PositiveSmallIntegerField(default=0, choices=[
        (0, "waiting for pay img"), (1, "waiting for confirm"), (2, "first confirmed"), (3, "secoend confirm"),
        (10, "denied")
    ])
